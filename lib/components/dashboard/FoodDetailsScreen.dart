...
import 'package:vipco_mega_wallet/components/component/MoreFoodsComponent.dart';
...
class FoodDetailsScreen extends StatefulWidget {
  ...
  final PopularItemModel? data;
  final bool isFoodFromHome;
  final bool isFoodFromShipping;

  FoodDetailsScreen(
      {this.data,
      this.isFoodFromHome = false,
      this.isFoodFromShipping = false});
...
class FoodDetailsScreenState extends State<FoodDetailsScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: widAppButton(
