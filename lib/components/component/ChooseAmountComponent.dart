...
class ChooseAmountComponent extends StatefulWidget {
  static String tag = '/FDChooseAmountComponent';

  @override
  ChooseAmountComponentState createState() => ChooseAmountComponentState();
}

class ChooseAmountComponentState extends State<ChooseAmountComponent> {
      ...
      child: Stack(
        children: [
            ...
            children: [
              ...
              Row(
                children: [
                  Container(
                    child: Text('-')
                        .paddingOnly(left: 10, right: 10, top: 4, bottom: 4),
          ...
          Positioned(
            ...
            right: 16,
            bottom: 16,
            child: widAppButton(isCart ? FDRedColor : FDPrimaryColor, () {
              setState(() {
                isCart = !isCart;
              });
