...
class FilterComponent extends StatefulWidget {
  ...
  @override
  FilterComponentState createState() => FilterComponentState();
}

class FilterComponentState extends State<FilterComponent> {
  List<String> optionsList = ['Delivery', 'Pickup'];
  List<IconData> optionsIconList = [
